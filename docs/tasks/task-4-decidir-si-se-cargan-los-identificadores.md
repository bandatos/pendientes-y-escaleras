...
Contexto agregado el 2026-08-26 ([[2026-08-26-sesion-mapeo-osm]]): 159 de los 185 `StairReport` ya traen el código físico STC en su propio `code_identifiers` (patrón `2SA11S`), así que parte del match puede salir de los reportes sin el cruce difuso con el CSV. Ese código es el candidato a `ref` en OSM ([[adr-0003]]). Pablo asignó además identificadores a todas las escaleras en Miro: [[task-14]].
